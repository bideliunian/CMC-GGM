...
save.path <- "~/work/CMC-GGM/Model_c/Results/p100"
...
save(df, file=paste(save.path,"/ROC.c.100.cmcopula.seed",rand.seed,".Rdata",sep=""))
...
save(df, file=paste(save.path,"/ROC.c.100.copula.seed",rand.seed,".Rdata",sep=""))
...
save(df, file=paste(save.path,"/ROC.c.100.gauss.seed",rand.seed,".Rdata",sep=""))
