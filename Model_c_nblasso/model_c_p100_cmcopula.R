...
working.path <- "~/work/CMC-GGM/Model_c_nblasso"
save.path <- "~/work/CMC-GGM/Model_c_nblasso/Results"
...
save(df.list, file=paste(save.path,"/ROC.c.100.cmcopula.nbd.Rdata",sep=""))