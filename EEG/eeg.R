...
est.cmc.control = fgm.eeg(score=fpca.score.control, p=p, trans='cmcopula',lambda = 1.5)
...
est.cmc.alcohol = fgm.eeg(score=fpca.score.alcohol, p=p, trans='cmcopula', lambda = 1.5)
